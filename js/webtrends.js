...
// Created: 9/27/2010 7:40:14 AM

function WebTrends(){
	var that=this;
	// begin: user modifiable
	this.dcsid="dcs4fi8f710000c11r6vio0hb_6x4y";
	this.domain="tagging.novartis.com";
	this.timezone=-5;
	this.fpcdom="";
	this.onsitedoms=(function(){return(window.RegExp?new RegExp("otrivin.com","i"):"");})();
...
WebTrends.prototype.dcsFPC=function(){
	...
	if (WT.co_f.indexOf("-")>-1) {
	    ...
	    _tag.DCS.dcscip=sTempLeft;
	}
	else{
	    _tag.DCS.dcscip=WT.co_f;
	}	
